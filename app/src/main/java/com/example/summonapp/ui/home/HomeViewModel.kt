 ...
 */
class HomeViewModel(monsterRepository: MonsterRepository) : ViewModel() {

    /**
     * Holds home ui state. The list of items are retrieved from [MonsterRepository] and mapped to
     * [HomeUiState]
     */
    val homeUiState: StateFlow<HomeUiState> =
        monsterRepository.getAllMonstersStream().map { HomeUiState(it) }
            .stateIn(
